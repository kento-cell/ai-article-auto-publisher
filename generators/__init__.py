"""Generators package for creating article content.

Submodules:
    claude_automator  - Selenium-based Claude.ai browser automation.
    local_llm         - Ollama / CodeLlama local inference client.
